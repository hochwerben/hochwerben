...
const Card = () => {
  ...
  {
    file(relativePath: { eq: "dd/transporter-grafiken-komplex.jpg" }) {
      childImageSharp {
        fluid(maxWidth: 600) {
    ...
    <div className={styles.container}>
      <div className={styles.card}>
        <h3 className={styles.heading}>
          Komplex
          <span className={styles.price}>ab € 875 <span className={styles.mwst}>zzgl. 19% MwSt.</span></span>
        </h3>
